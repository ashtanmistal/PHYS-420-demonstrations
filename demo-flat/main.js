...
function addCubes(cubeGeometry, worldFrame, scene) {
  ...
  cube2.position.set(77.0 - (10.0 + cubeOffset), cubeSize + cubeOffset, 39.0 - (10.0 - cubeOffset));
  cube2.parent = worldFrame;
  scene.add(cube2);

  const cube3 = new THREE.Mesh(cubeGeometry, woodMaterial);
  cube3.position.set(77.0 - (10.0 - cubeOffset), cubeOffset, 39.0 - (10.0 + cubeOffset));
  cube3.parent = worldFrame;
  scene.add(cube3);

  const cube4 = new THREE.Mesh(cubeGeometry, woodMaterial);
  cube4.position.set(77.0 - (10.0 - cubeOffset), cubeOffset, 39.0 - (20.0 - cubeOffset));
  cube4.parent = worldFrame;
  scene.add(cube4);

  const cube5 = new THREE.Mesh(cubeGeometry, woodMaterial);
  cube5.position.set(77.0 - (10.0 - cubeOffset), cubeOffset, 39.0 - (20.0 + cubeOffset));
  cube5.parent = worldFrame;
  scene.add(cube5);

  const cube6 = new THREE.Mesh(cubeGeometry, metalMaterial);
  cube6.position.set(77.0 - (30.0 - Math.sqrt(cubeOffset ** 2 + (cubeSize / 2) ** 2)), cubeOffset, 39.0 - (10.0 + Math.sqrt(cubeSize ** 2 + (cubeSize / 2) ** 2)));
  ...
  cube7.position.set(77.0 - (20.0 + cubeOffset), cubeOffset, 39.0 - (20.0 - cubeOffset));
  cube7.parent = worldFrame;
  scene.add(cube7);

  const cube8 = new THREE.Mesh(cubeGeometry, feltMaterial);
  cube8.position.set(77.0 - (20.0 + cubeOffset), cubeSize + cubeOffset, 39.0 - (20.0 - cubeOffset));
  cube8.parent = worldFrame;
  scene.add(cube8);

  const cube9 = new THREE.Mesh(cubeGeometry, metalMaterial);
  cube9.position.set(77.0 - (20.0 - cubeOffset), cubeOffset, 39.0 - (30.0 - cubeOffset));
  cube9.parent = worldFrame;
  scene.add(cube9);

  const cube10 = new THREE.Mesh(cubeGeometry, feltMaterial);
  cube10.position.set(77.0 - (30.0 + cubeOffset), cubeOffset + cubeSize, 39.0 - (10.0 - cubeOffset));
  cube10.parent = worldFrame;
  scene.add(cube10);

  const cube11 = new THREE.Mesh(cubeGeometry, woodMaterial);
  cube11.position.set(77.0 - (30.0 + cubeOffset), cubeOffset, 39.0 - (10.0 - cubeOffset));
  cube11.parent = worldFrame;
  scene.add(cube11);

  const cube12 = new THREE.Mesh(cubeGeometry, metalMaterial);
  cube12.position.set(77.0 - (40.0 - Math.sqrt(cubeOffset ** 2 + (cubeSize / 2) ** 2)), cubeOffset, 39.0 - (10.0 - Math.sqrt(cubeSize ** 2 + (cubeSize / 2) ** 2)));
  // the above is needed to set the boundaries correctly for a rotated cube
  ...
  cube13.position.set(77.0 - (40.0 + Math.sqrt(cubeOffset ** 2 + (cubeSize / 2) ** 2)), cubeOffset, 39.0 - (10.0 - Math.sqrt(cubeSize ** 2 + (cubeSize / 2) ** 2)));
  // the above is needed to set the boundaries correctly for a rotated cube
  ...
  cube14.position.set(77.0 - (40.0 + cubeOffset), cubeOffset, 39.0 - (20.0 + cubeOffset));
  cube14.parent = worldFrame;
  scene.add(cube14);

  const cube15 = new THREE.Mesh(cubeGeometry, woodMaterial);
  cube15.position.set(77.0 - (40.0 - cubeOffset), cubeSize + cubeOffset, 39.0 - (30.0 - cubeOffset));
  cube15.parent = worldFrame;
  scene.add(cube15);

  const cube16 = new THREE.Mesh(cubeGeometry, feltMaterial);
  cube16.position.set(77.0 - (40.0 - cubeOffset), cubeOffset, 39.0 - (30.0 - cubeOffset));
  cube16.parent = worldFrame;
  scene.add(cube16);

  const cube17 = new THREE.Mesh(cubeGeometry, metalMaterial);
  cube17.position.set(77.0 - (50.0 + cubeOffset), cubeOffset, 39.0 - (10.0 - cubeOffset));
  cube17.parent = worldFrame;
  scene.add(cube17);

  const cube18 = new THREE.Mesh(cubeGeometry, metalMaterial);
  cube18.position.set(77.0 - (50.0 + cubeOffset), cubeOffset, 39.0 - (20.0 - cubeOffset));
