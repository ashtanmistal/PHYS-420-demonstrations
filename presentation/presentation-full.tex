...
\begin{document}
  ...
  \begin{frame}
    ...
    From there, go to "WebGL Demonstration" and click on "Scene Geometry". %% TODO add this to the website
  ...
  \begin{frame}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.4\textwidth]{flat-shading.png}
      \includegraphics[width=0.4\textwidth]{gouraud-shading.png}
...
for each light source:
  ...
  \begin{frame}
    ...
    %% TODO - add a picture of the scene here
